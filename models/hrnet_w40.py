...
def stem_net(input):
    ...
    x = bottleneck_Block(x, 320, with_conv_shortcut=True)
    x = bottleneck_Block(x, 320, with_conv_shortcut=False)
    x = bottleneck_Block(x, 320, with_conv_shortcut=False)
    x = bottleneck_Block(x, 320, with_conv_shortcut=False)
...
def transition_layer1(x, out_filters_list=[40, 80]):
...
def make_branch1_0(x, out_filters=40):
...
def make_branch1_1(x, out_filters=80):
    x = basic_Block(x, out_filters, with_conv_shortcut=False)
    x = basic_Block(x, out_filters, with_conv_shortcut=False)
    x = basic_Block(x, out_filters, with_conv_shortcut=False)
    x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def fuse_layer1(x):
    x0_0 = x[0]
    x0_1 = Conv2D(40, 1, use_bias=False, kernel_initializer='he_normal')(x[1])
    x0_1 = BatchNormalization(axis=3)(x0_1)
    x0_1 = UpSampling2D(size=(2, 2), interpolation="bilinear")(x0_1)
    x0 = add([x0_0, x0_1])

    x1_0 = Conv2D(80, 3, strides=(2, 2), padding='same', use_bias=False, kernel_initializer='he_normal')(x[0])
...
def transition_layer2(x, out_filters_list=[40, 80, 160]):
...
def make_branch2_0(x, out_filters=40):
    for i in range(4):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def make_branch2_1(x, out_filters=80):
    for i in range(4):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def make_branch2_2(x, out_filters=160):
    for i in range(4):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def fuse_layer2(x):
    ...
    x0_1 = BatchNormalization(axis=3)(x0_1)
    x0_1 = UpSampling2D(size=(2, 2), interpolation="bilinear")(x0_1)
    x0_2 = Conv2D(40, 1, use_bias=False, kernel_initializer='he_normal')(x[2])
    ...
    x1_0 = BatchNormalization(axis=3)(x1_0)
    x1_1 = x[1]
    x1_2 = Conv2D(80, 1, use_bias=False, kernel_initializer='he_normal')(x[2])
    x1_2 = BatchNormalization(axis=3)(x1_2)
    x1_2 = UpSampling2D(size=(2, 2), interpolation="bilinear")(x1_2)
    x1 = add([x1_0, x1_1, x1_2])

    x2_0 = Conv2D(40, 3, strides=(2, 2), padding='same', use_bias=False, kernel_initializer='he_normal')(x[0])
    x2_0 = BatchNormalization(axis=3)(x2_0)
    x2_0 = Activation('relu')(x2_0)
    x2_0 = Conv2D(160, 3, strides=(2, 2), padding='same', use_bias=False, kernel_initializer='he_normal')(x2_0)
    x2_0 = BatchNormalization(axis=3)(x2_0)
    x2_1 = Conv2D(160, 3, strides=(2, 2), padding='same', use_bias=False, kernel_initializer='he_normal')(x[1])
...
def transition_layer3(x, out_filters_list=[40, 80, 160, 320]):
    x0 = Conv2D(out_filters_list[0], 3, padding='same', use_bias=False, kernel_initializer='he_normal')(x[0])
    x0 = BatchNormalization(axis=3)(x0)
    x0 = Activation('relu')(x0)
...
def make_branch3_0(x, out_filters=40):
    for i in range(3):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def make_branch3_1(x, out_filters=80):
    for i in range(3):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def make_branch3_2(x, out_filters=160):
    for i in range(3):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def make_branch3_3(x, out_filters=320):
    for i in range(3):
        residual = x
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
        x = basic_Block(x, out_filters, with_conv_shortcut=False)
...
def fuse_layer3(x):
    ...
    x0_2 = BatchNormalization(axis=3)(x0_2)
    x0_2 = UpSampling2D(size=(4, 4), interpolation="bilinear")(x0_2)
    x0_3 = Conv2D(40, 1, use_bias=False, kernel_initializer='he_normal')(x[3])
...
def HRNet_W40(input_height, input_width, n_classes=20, channel=3, layername='model'):
    ...
    model = tf.keras.models.Model(inputs=inputs, outputs=out, name="HRNet_W40")
