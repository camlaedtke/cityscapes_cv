...
def HRNet_small(input_height, input_width, n_classes=20, W=32, channel=3, layername='model'):
    ...
    model = tf.keras.models.Model(inputs=inputs, outputs=out, name="HRNet_small_W{}".format(W))
